...
void ui_Home_screen_init(void)
{
    ...
    ui_Home_Roller1 = lv_roller_create(ui_Home);
    lv_roller_set_options(ui_Home_Roller1, "Option 1\nOption 2\nOption 3", LV_ROLLER_MODE_NORMAL);
    lv_obj_set_height(ui_Home_Roller1, 59);
    lv_obj_set_width(ui_Home_Roller1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_align(ui_Home_Roller1, LV_ALIGN_CENTER);
